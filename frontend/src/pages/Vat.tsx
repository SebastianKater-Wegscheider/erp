...
export function VatPage() {
  ...
  return (
    <div className="space-y-4">
      <div className="text-xl font-semibold">VAT</div>
      ...
      <div className="grid gap-4 md:grid-cols-4">
        <Card>
          <CardHeader>
            <CardTitle>Output VAT (Regular)</CardTitle>
          </CardHeader>
        ...
        <Card>
          <CardHeader>
            <CardTitle>Output VAT (Margin)</CardTitle>
          </CardHeader>
          <CardContent className="text-2xl font-semibold">
